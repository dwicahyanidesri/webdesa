...
@section('content')
<form method="POST" action="{{ route('admin.program-kerja.update', $item) }}" enctype="multipart/form-data" class="max-w-xl bg-white rounded-2xl border border-emerald-900/10 p-6 space-y-4">
    @csrf
    @method('PUT')
